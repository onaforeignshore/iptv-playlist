...
async function uploadUpdateFile(fileName, jsonData) {
    const url = `https://api.github.com/repos/onaforeignshore/iptv-playlist/contents/playlist/${fileName}.json`
    const secret_hash = await getSecretHash(url)
    const data = JSON.stringify({
        message: 'Update file',
        committer: { name: 'onaforeignshore', email: 'onaforeignshore@gmail.com' },
